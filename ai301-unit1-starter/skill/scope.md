...
I am most comfortable with Python and Markdown, and I am building confidence
with small web-facing fixes and documentation changes. I prefer issues with a
clear reproduction or acceptance condition, a focused file or component
boundary, and a test or documentation path I can verify locally. I want to
avoid broad architectural migrations, undefined product decisions, and tasks
that require specialized infrastructure before I can reproduce the behavior.
